...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Manu-MD&XdUFTbBA#Ywi5Ax5ZcyH6MreZuRQYDEmdNyekQeGsMvcQsm2rA50", // Session id එක දාන්න " " ඕව මැදට creds.json දානව නම් ඕව වෙනස් කරන්න එපා...✓💚
...
OWNER_NUMBER : process.env.OWNER_NUMBER || "916282524515", // ඔයාගෙ නම්බරේ ඔතනට දාගන්න මුලට 94 තියෙන්න ඕනි 0 දාන්න එපා !
DELCHAT : process.env.DELCHAT || "pm",
FOOT : process.env.FOOT || "🧚‍♀️ ᴀɴsʜɪғ xᴇʀ-𝗩❼💗",
